...
export const DynamicHero = ({ media, description, buttons }: {media: any, description: string, buttons: any[]}) => {
  ...
  const isVideo = fileExtension ? videoExtensions.includes(fileExtension) : false;
  ...
  return (
    <section ref={heroRef} className="relative h-screen overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 h-full flex flex-col justify-center items-center text-secondary">
        <div className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl mb-8 max-w-4xl text-center transition-opacity duration-1000 ${
