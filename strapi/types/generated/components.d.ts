...
export interface ItemsPredMessage extends Struct.ComponentSchema {
  collectionName: 'components_items_pred_messages';
  info: {
    displayName: 'PredMessage';
    icon: 'message';
  };
  attributes: {
    messageText: Schema.Attribute.String;
...
export interface ItemsInput extends Struct.ComponentSchema {
  ...
  attributes: {
    ...
    target_submit: Schema.Attribute.Enumeration<
      ['_blank', '_self', '_parent', '_top']
    >;
    variant_submit: Schema.Attribute.Enumeration<
      ['simple', 'outline', 'primary', 'muted']
    >;
    function_submit: Schema.Attribute.Enumeration<['sendContactForm']>;
  };
}
...
export interface DynamicZonePlayList extends Struct.ComponentSchema {
  collectionName: 'components_dynamic_zone_play_lists';
  info: {
    displayName: 'PlayList';
    icon: 'music';
  };
  attributes: {
    audio: Schema.Attribute.Media<'audios' | 'videos', true>;
  };
}
...
export interface DynamicZoneDynamicHero extends Struct.ComponentSchema {
  collectionName: 'components_dynamic_zone_dynamic_heroes';
  info: {
    displayName: 'DynamicHero';
    icon: 'command';
    description: '';
  };
  attributes: {
    ...
    url: Schema.Attribute.String;
    messages: Schema.Attribute.Component<'items.pred-message', true>;
  };
}
...
export interface DynamicZoneCharacterInfo extends Struct.ComponentSchema {
  collectionName: 'components_dynamic_zone_character_infos';
  info: {
    displayName: 'characterInfo';
    icon: 'alien';
  };
  attributes: {
    gamified_character: Schema.Attribute.Relation<
      'oneToOne',
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ComponentSchemas {
      ...
      'items.pred-message': ItemsPredMessage;
      ...
      'dynamic-zone.play-list': DynamicZonePlayList;
      ...
      'dynamic-zone.dynamic-hero': DynamicZoneDynamicHero;
      'dynamic-zone.cta': DynamicZoneCta;
      'dynamic-zone.character-info': DynamicZoneCharacterInfo;
