...
export interface ApiCharacterCharacter extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    charID: Schema.Attribute.UID<'nickname'>;
    ...
    user: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    gamified_characteristics: Schema.Attribute.Relation<
      'manyToMany',
      'api::characteristic.characteristic'
    >;
    gamified_quests: Schema.Attribute.Relation<
      'manyToMany',
      'api::gamified-quest.gamified-quest'
    >;
    characteristicsState: Schema.Attribute.JSON &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiCharacteristicCharacteristic
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['Skill', 'Knowledge']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    gamified_progression: Schema.Attribute.Relation<
      'oneToOne',
      'api::gamified-progression.gamified-progression'
    >;
    gamified_characters: Schema.Attribute.Relation<
      'manyToMany',
      'api::character.character'
    >;
    ProgressionDescription: Schema.Attribute.JSON &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    gamified_categories: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiContactFormContactForm extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    contactDate: Schema.Attribute.DateTime;
    isClient: Schema.Attribute.Boolean;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiGamifiedCategoryGamifiedCategory
  extends Struct.CollectionTypeSchema {
  collectionName: 'gamified_categories';
  info: {
    singularName: 'gamified-category';
    pluralName: 'gamified-categories';
    displayName: 'Gamified_Category';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiGamifiedProgressionGamifiedProgression
  extends Struct.CollectionTypeSchema {
  collectionName: 'gamified_progressions';
  info: {
    singularName: 'gamified-progression';
    pluralName: 'gamified-progressions';
    displayName: 'Gamified_Progression';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    name: Schema.Attribute.String;
    progressionRules: Schema.Attribute.JSON;
...
export interface ApiGamifiedQuestGamifiedQuest
  extends Struct.CollectionTypeSchema {
  collectionName: 'gamified_quests';
  info: {
    singularName: 'gamified-quest';
    pluralName: 'gamified-quests';
    displayName: 'Gamified_Quest';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    dynamic_zone: Schema.Attribute.DynamicZone<
      [
        ...
        'dynamic-zone.form-next-to-section',
        'dynamic-zone.faq',
        'dynamic-zone.dynamic-hero',
        'dynamic-zone.character-info',
      ]
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::gamified-category.gamified-category': ApiGamifiedCategoryGamifiedCategory;
      'api::gamified-progression.gamified-progression': ApiGamifiedProgressionGamifiedProgression;
      'api::gamified-quest.gamified-quest': ApiGamifiedQuestGamifiedQuest;
